      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join the world's most innovative companies and accelerate your
            career growth with these industry leaders
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {companiesWithJobCounts.map((company, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${getGradient(company.industry)} rounded-3xl opacity-0 group-hover:opacity-10 transition-opacity duration-500 blur-xl`}
                ></div>

                <div className="relative z-10">
                  <div
                    className={`mb-6 p-4 bg-gradient-to-br ${getGradient(company.industry)} rounded-2xl inline-block transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}
                  >
                  ...
                  <span
                    className={`inline-block text-sm font-bold px-4 py-2 rounded-full bg-gradient-to-r ${getGradient(company.industry)} text-white shadow-lg transform group-hover:scale-105 transition-transform duration-300`}
                  >
                    {company.industry}
                  </span>
                </div>

    ...
    const loadJobAndApplications = async () => {
      ...
      try {
        ...
        const transformedApplications = applicationsData.map((app) => {
          ...
          if (profile?.resume) {
            console.log(
              "[JobApplicants] Resume data type:",
          ...
          if (profile?.profilePicture) {
            console.log(
              "[JobApplicants] Profile picture type:",
              typeof profile.profilePicture,
              "Length:",
              profile.profilePicture?.length,
            );
        ...
        console.log(
          "[JobApplicants] Transformed applications:",
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-3 mb-4">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(application.applicant.status)}`}
                          >
            ...
            <div className="p-8 overflow-y-auto max-h-[85vh]">
              <div className="text-center mb-8">
                <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-lg mx-auto mb-4">
                  ...
                  <div
                    className={`w-full h-full bg-gradient-to-br from-primary-600 to-purple-600 dark:from-primary-500 dark:to-purple-500 flex items-center justify-center ${selectedApplicant.profileImage ? "hidden" : ""}`}
                  >

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 pt-20">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="flex items-center space-x-4">
                  <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <div
                      className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${remoteOnly ? "bg-primary-600" : "bg-gray-300 dark:bg-gray-600"}`}
                    >
                      <div
                        className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform duration-300 ${remoteOnly ? "transform translate-x-6" : ""}`}
                      ></div>
                    </div>
      ...
      <ConfirmationModal
        ...
        message={
          selectedJob
            ? `You are about to apply for the position of ${selectedJob.title} at ${selectedJob.company}. Make sure your profile is up to date before submitting your application.`
            : ""
        }

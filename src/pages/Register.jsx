...
const Register = () => {
  ...
  return (
    <div
      className={`min-h-[calc(100vh-5rem)] ${theme === "dark" ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-br from-gray-50 via-white to-primary-50"} flex items-center justify-center px-4 py-12 relative`}
    >
      {/* Background Elements */}
      ...
      <div className="relative z-10 w-full max-w-md">
        <div
          className={`${theme === "dark" ? "bg-gray-800/80 border-gray-700/30" : "bg-white/80 border-white/20"} backdrop-blur-lg shadow-2xl rounded-3xl p-8 border`}
        >
          {/* Header */}
          <div className="text-center mb-8">
            ...
            <p
              className={`${theme === "dark" ? "text-gray-300" : "text-gray-600"} text-lg`}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label
                className={`block text-sm font-semibold ${theme === "dark" ? "text-gray-300" : "text-gray-700"} mb-2`}
              >
                Full Name
              </label>
              <input
            ...
            {successMessage && (
              <div
                className={`p-4 rounded-xl text-sm font-medium ${theme === "dark" ? "bg-green-900/30 border border-green-700 text-green-300" : "bg-green-50 border border-green-200 text-green-700"}`}
              >
            ...
            {errors.general && (
              <div
                className={`p-4 rounded-xl text-sm font-medium ${theme === "dark" ? "bg-red-900/30 border border-red-700 text-red-300" : "bg-red-50 border border-red-200 text-red-700"}`}
              >
                <div className="flex items-center space-x-2">
                  <svg
                    className="w-5 h-5 flex-shrink-0"
